import { Legend, SubTitle, Tooltip, BarController, BarElement, CategoryScale, Chart, LinearScale } from "chart.js";
...
export class App {
    ...
    constructor() {
        Chart.register(Legend, SubTitle, Tooltip, LinearScale, CategoryScale, BarController, BarElement, Log2Axis);
